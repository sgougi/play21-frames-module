...
public class IdMethodHandler implements MethodHandler<Id> {

	@Override
	public Object processElement(final Object frame, final Method method, final Object[] arguments, final Id annotation, final FramedGraph<?> framedGraph, final Element element) {
	...
	private Object processEdge(final Id annotation, final Method method, final Object[] arguments, final FramedGraph framedGraph, final Edge element) {
		final EdgeFrame frame = (EdgeFrame) framedGraph.frame(element, Edge.class);
